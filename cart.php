                ...
                <div class="col-sm-6 col-sm-offset-3">
                    <table class="table table-striped table-bordered">
                        ...
                        if (mysqli_num_rows($result) >= 1) {
                            ...
                            echo "<div class='container-fluid' id='content' style='height: 535px;'>
            <div class='col-md-12' style='margin-top: 140px;'>
                <div class='jumbotron'>

                      <h3 align='center'>Add items to the cart first!&#128540;</h3><hr>
                    <p class='text-center' style='font-weight: 400'>Click <a href='index.php'>here</a> to purchase any item.</p>
                </div>
            </div>
        </div>";
                        }
